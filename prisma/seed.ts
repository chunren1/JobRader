  ...
  const jobs = await Promise.all([
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_001.html",
        aiScore: 92,
    ...
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_002.html",
        aiScore: 78,
    ...
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_003.html",
        aiScore: 35,
    ...
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_004.html",
        aiScore: 88,
    ...
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_005.html",
        aiScore: 96,
    ...
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_006.html",
        aiScore: 65,
    ...
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_007.html",
        aiScore: 10,
    ...
    prisma.job.create({
      data: {
        ...
        rawUrl: "https://www.zhipin.com/job_detail/mock_008.html",
        aiScore: 45,
