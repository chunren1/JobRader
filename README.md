# JobRadar — Boss直聘高质量岗位智能聚合

> 个人效率工具 · AI 驱动 · 数据仅存储于本地

JobRadar 是一款基于 Chrome 浏览器插件 + Next.js + AI 的个人效率工具。在浏览 Boss直聘时，通过插件提取岗位数据，结合 AI 语义分析为你智能评分，帮你快速识别高质量岗位，过滤外包、虚假和低质职位。
...
curl -X POST http://localhost:3000/api/jobs/ingest \
  ...
  -d '{"jobs":[{"title":"测试岗位","company":"测试公司","location":"北京","jdContent":"这是一个测试JD","tags":["React"],"rawUrl":"https://example.com/test","source":"zhipin"}]}'
```
